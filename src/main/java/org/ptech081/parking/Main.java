...
public class Main {
    public static void main(String[] args) {
        ...
        Registro registro1 = new  Registro(fechaInicio, horaInicio, fechaFin, horaFin, 10000L, cupo1, cliente1.misCarros.get(1), cliente1);
        ...
        //crear registro 
        Registro registro2 = new Registro (fechaInicio2, horaInicio2, fechaFin2, horaFin2, 25000L, cupo2, cliente2.misCarros.get(1), cliente2);
        ...
        for(Registro r: misRegistros){
            System.out.println("Cliente" + r.cliente.nombre + " " + r.cliente.apellidos + "|" + r.vehiculo.placa +" " 
                                            + r.vehiculo.tipoVehiculo +"|" + r.valor + "|" + r.fechaInicio +"|" + r.horaInicio +"|" + r.fechaFin +"|" + r.horaFin +"|");
        }
